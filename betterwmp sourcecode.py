...
SkinInfo = {}
ffmpeg_path = r"C:\Program Files\betterwmp\ffmpeg.exe"
...
if AudioSegment.converter is None:
    ...
    messagebox.showwarning(
        "FFmpeg Not Found",
        f"FFmpeg executable was not found in the application directory. Non-WAV files will not be opened properly.\nExpected path: {ffmpeg_path}"
    )
    root.destroy()
